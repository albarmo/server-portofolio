...
module.exports = {
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.removeConstraint(
      "Wishlists",
      "Fkey_Wishlists_to_User",
      {}
    );
    await queryInterface.removeConstraint(
      "Wishlists",
      "Fkey_Wishlists_to_Product",
      {}
    );
    await queryInterface.removeConstraint(
      "Transactions",
    ...
    await queryInterface.removeConstraint(
      "Histories",
      "Fkey_Histories_to_User",
      {}
    );

    await queryInterface.removeConstraint(
      "Histories",
      "Fkey_Histories_to_Transactions",
      {}
    );

    await queryInterface.removeConstraint(
      "Collections",
      "Fkey_Collections_to_Products",
      {}
    );
